...
class ConvertTemp extends JFrame {
    ...
    public ConvertTemp () {
        ...
        super ("Temperature Conversion Calculator");
        setLayout (new FlowLayout ());

        labelFahr = new JLabel ("Fahrenheit: ", SwingConstants.LEFT);
        labelFahr.setToolTipText("This is a temperature scale");
        add (labelFahr);
        textFahr = new JTextField (7);
        add (textFahr);

        labelCels = new JLabel ("Celsius:       ", SwingConstants.LEFT);
        labelCels.setToolTipText("This is a temperature scale and unit of measurement for temperature");
        add (labelCels);
